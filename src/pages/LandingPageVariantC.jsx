  ...
  const handleAgentClick = () => {
    ...
    if (window.va) {
      window.va('event', {
        ...
        data: { location: 'hero', variant: 'free' }
      });
    }
    navigate('/agents');
  };
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 py-16 sm:py-24">
        ...
        <header className="mb-32 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-8 bg-emerald-50 dark:bg-emerald-950/30 rounded-full border border-emerald-200 dark:border-emerald-800">
            ...
            <span className="text-sm text-emerald-700 dark:text-emerald-400 font-medium">100% Free Forever • No Credit Card • No Signup</span>
          </div>

          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-8 leading-tight tracking-tight">
            <span className="text-gray-900 dark:text-white">Free AI automation for PMs. </span>
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent">
              No $99/mo subscriptions.
            </span>
          </h1>

          <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed">
            Get business cases, risk audits, and competitive intelligence—completely free. No paywalls. No upgrade prompts. Just AI agents that work.
          </p>
        ...
        <section className="mb-32">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              4 AI agents, 100% free
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Each agent automates a PM deliverable that typically takes days. Get instant output you can use immediately. No hidden costs.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-3xl border-2 border-gray-200 dark:border-gray-700 p-12">
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
                  157 tactical frameworks (also free)
                </h2>
                <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
                  The agents automate output. The frameworks build expertise. Strategy, Risk, Execution—fully covered. No paywalls.
                </p>
              </div>
        ...
        <section className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-3xl mx-auto">
            No credit card required. No "freemium" upsells. No hidden costs. Just AI agents and frameworks that actually help you ship.
          </p>
          <button
          ...
          <p className="text-sm text-gray-500 dark:text-gray-500">
            100% free forever • No signup • All 4 agents + 157 frameworks
          </p>
        </section>
...
export default LandingPageVariantC;
