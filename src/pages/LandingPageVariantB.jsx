  ...
  const handleAgentClick = () => {
    ...
    if (window.va) {
      window.va('event', {
        ...
        data: { location: 'hero', variant: 'pain' }
      });
    }
    navigate('/agents');
  };
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 py-16 sm:py-24">
        ...
        <header className="mb-32 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-8 leading-tight tracking-tight">
            ...
            <span className="text-gray-900 dark:text-white"> on business cases and risk audits</span>
          </h1>

          <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed">
            AI agents generate your PM deliverables in hours while you focus on strategy. No more late nights building ROI models or auditing risks manually.
          </p>
        ...
        <section className="text-center">
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Free yourself from manual PM work
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-3xl mx-auto">
            No more late nights building ROI models. No more weeks spent auditing risks. Let AI agents handle the grunt work.
          </p>
          <button
...
export default LandingPageVariantB;
