  ...
  const handleAgentClick = () => {
    ...
    if (window.va) {
      window.va('event', {
        ...
        data: { location: 'hero', variant: 'speed' }
      });
    }
    navigate('/agents');
  };
      ...
      <div className="max-w-6xl mx-auto px-6 sm:px-8 py-16 sm:py-24">
        ...
        <header className="mb-32 text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-8 leading-tight tracking-tight">
            <span className="text-gray-900 dark:text-white">Get PM deliverables done </span>
          ...
          <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed">
            Business cases in 2 hours. Risk audits in 1 afternoon. Competitive analysis in minutes. AI agents that generate deliverables you can use immediately.
          </p>
        ...
        <section className="text-center">
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Get deliverables done in hours, not weeks
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 max-w-3xl mx-auto">
            Stop spending weeks on manual work. Let AI agents generate business cases, risk audits, and competitive intelligence in hours.
          </p>
          <button
...
export default LandingPageVariantA;
